...
if(!defined('IWP_MMB_CLIENT_VERSION'))
	define('IWP_MMB_CLIENT_VERSION', '1.9.1');
...
if( !function_exists ( 'iwp_mmb_new_scheduled_backup' )) {
	function iwp_mmb_new_scheduled_backup($params)
	{
		...
		if ((defined('DISABLE_IWP_CLOUD_VERIFICATION') && !DISABLE_IWP_CLOUD_VERIFICATION) || (empty($params['args']['disable_iwp_cloud_verification']))) {
...
if(isset($_GET['auto_login'])){
	if (!defined('ITSEC_DISABLE_MODULES')) {
